...
👉 **[マップを開く](https://shiwaku.github.io/plateau-2024-building-attributes/)**
...
### スマートフォン対応
画面左上の **☰** ボタンでパネルを開閉できます。パネル内の **✕** ボタンで閉じて地図に戻れます。

## ファイル構成

```
.
├── index.html        # MapLibreインタラクティブマップ（メイン成果物）
├── scripts/
│   └── generate.py                         # CSV・HTML生成スクリプト
├── data/
│   ├── attributedata_2024_v4_r3.xlsx       # 元データ（PLATEAU属性情報公開リスト 2024年度版）
│   └── attributedata_2024_v3_r2.xlsx       # 旧バージョン
└── output/
